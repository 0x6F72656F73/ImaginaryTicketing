...
# print([challenge.title for challenge in challenges])
...
print(options)
# new_challenges = [Others.Challenge(
#     i, f"chall{i}", f"author{i}", i % 3 == 0) for i in range(10)]
...
#         challenge["id"], challenge["author"], challenge["title"], ignore))
